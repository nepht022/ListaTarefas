<?php
	$acao = 'recuperar';//recupera todas as tarefas pelo metodo do controller
							...
							<div class="col">
								...
								<?php foreach($tarefas as $indice => $tarefa){ ?>
									<div class="row mb-3 d-flex align-items-center tarefa">
										<!--exibe o valor do id, nome e status das tarefas recuperadas pelo metodo recuperar-->
										...
										<div class="col-sm-3 mt-2 d-flex justify-content-between">
											...
											<!--se o id_status da tarefa for 2 e o status='pendente', será possivel edita-la e marca-la como resolvida-->
